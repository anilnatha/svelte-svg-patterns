...
let languages = [
  ...
  },
  {
    ...
    name: "日本語",
    col: 25,
    site: "https://ja.pattern.monster",
    path: "../ja.pattern.monster/",
  },
  {
    lang: "ko",
    name: "한국어",
    col: 26,
    site: "https://ko.pattern.monster",
    path: "../ko.pattern.monster/",
  },
];
...
Crawl-Delay: 20`);
      ...
      // pro/_index.js
      if (language.lang == "en") {
        let newValues = printObject(language.col, "premium");

        writeStream = fs.createWriteStream(
          "../pro.pattern.monster/src/lib/_index.js"
        );
        writeStream.write("const index = ");
        writeStream.write(JSON.stringify(newValues));
        writeStream.write("; export default index;");
...
export default { strings, pageDetails, lightColors, darkColors };
      ...
      function printObject(col, pro) {
        ...
        for (let j = 1; j < rows.length; j++) {
          ...
          let isPremium = rows[j][15] === "premium";
          ...
          p.push({
            ...
            tags: newTag,
            path: row[12],
            creationDate: row[14], // recently changed
          });
        }
